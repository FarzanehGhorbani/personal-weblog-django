...
from extensions.utils import jalali_converter, date
...
from .models import AboutUs, HonorsAndAwards, Education
...
def home_page(request):
    ...
    books = Publications.objects.filter(active_for_top=True).order_by('-year', '-id')[:6]
